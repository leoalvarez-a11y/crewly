...
export const Help: React.FC = () => {
  ...
  return <div className="max-w-5xl mx-auto space-y-6">
    ...
    <div className="grid md:grid-cols-2 gap-3">{GUIDES.map((guide) => <a key={guide} href={`/docs/es/${guide}.md`} target="_blank" rel="noreferrer" className="rounded-lg border border-border-dark p-4 hover:border-primary"><span className="font-medium">{guide.replaceAll('-', ' ')}</span></a>)}</div>
